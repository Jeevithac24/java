class Library{
	public static void borrrow(String bookName){
	...
	public static void bookDetails(String bookName,String author,String publisherAddress,String edition,int bookNo,int noOfPage,short yearOfPublish,short quantity,double prize,boolean publish){
